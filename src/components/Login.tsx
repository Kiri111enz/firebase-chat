...
const Login: React.FC = () => {
    ...
    return (
        <Popup showCloseButton={false}>
            <button 
                className="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center m-2"
                onClick={() => signInWithPopup(auth, provider).catch(() => void 0)}>
